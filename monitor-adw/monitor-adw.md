...
Open the OAC browser and click **Auto Apply Data** button from bottom right.  
    ...
    ![Auto Apply Data](../monitor-adw/images/autoapplyoff3.png)  
...
8.  Click **Update**
    ...
    ![Monitored SQL](../monitor-adw/images/ociadwh-scaleup16ocpusmall2.png)
...
Select _Sales Week_ on the **Category (X-Axis)**  
...
4.  Click **Navigator** and then Select **Console**.

    ![Console](../monitor-adw/images/navigator-consolesmall.png)

5.  Click **Sessions and Query Cache** under _Configuration and Administration_ section.

    ![Sessions and Query Cache](../monitor-adw/images/sessionandquery.png)

6.  The logs screen shows all the query logs and it can be sorted in ascending/descending order.  
...
7.  Sort the query log in a descending order.  
   **Sort By**> Select **Order Time Descending**.

    ![Order Time Descending](../monitor-adw/images/managesessionsdesc.png)

8.  Pick-up the most recent one and Click **View Log**.

    ![View Log](../monitor-adw/images/managesessionsquery.png)

9. **Logs** contain **logical SQL** generated by the BI Server and the **physical SQL** fired against the database.  
...
11. **Copy** the **Logical SQL** from the log file. 

     ![Copy Logical SQL](../monitor-adw/images/copylog.png)

12. Go back to **Console** and Click **Issue SQL** under _Configuration and Administration_ section.  
    
     ![Issue SQL](../monitor-adw/images/issuesql.png)

13. Paste the _Logical SQL_ and Click **Issue SQL** button.  

     ![Sessions and Query Cache](../monitor-adw/images/issuesql2.png)

14. You can quickly see the results (unformatted table below the SQL query). 

     ![Sessions and Query Cache](../monitor-adw/images/issuesql3.png)

15. Go to the ADW **Service Console > Activity > Monitored SQL**, select your query, right-click and select **Show Details**.

     ![Show Details](../monitor-adw/images/adwshowdetails.png)

16. Check the **Overview** tab, you'll find the Physical **SQL Text** which is identical with the one from OAC query log. 

     ![Overview](../monitor-adw/images/adwshowdetails2.png)

17. You can also browse through the other tabs as **Plan Statistics** to see other relevant query information.
